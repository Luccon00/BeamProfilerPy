...
class Image:
    ...
    def subtract_dark(
        ...
        *,
        ...
        if debug_plot:
            ...
            ax.set_title("Dark-subtracted image (red = pixels subtracted)")
            ax.axis("off")
    ...
    def filters(
        ...
        if use_median:
            img = median_filter(img, size=5, mode='nearest')
        ...
        if use_gaussian:
            img = gaussian_filter(img, sigma=gaussian_sigma, order=0, mode='nearest')
